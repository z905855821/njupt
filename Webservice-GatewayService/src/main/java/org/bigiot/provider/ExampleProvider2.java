...
public class ExampleProvider2 {
	...
	private static final String PROVIDER_ID 	= "Njupt-njuptprovider2";
	private static final String PROVIDER_SECRET = "meTZNWuJTsKgkhwaD-X_qQ==";
...
//			return BigIotHttpResponse.okay().withBody(number).asJsonType();
	...
	public static void main(String args[]) throws InterruptedException, IncompleteOfferingDescriptionException, IOException, NotRegisteredException {
	    ...
	    RegistrableOfferingDescription offeringDescription = provider.createOfferingDescription("AirHumidityOffering")
	    		.withInformation(new Information ("Nanjing AirHumidity", new RDFType("bigiot:AirHumidity")))
