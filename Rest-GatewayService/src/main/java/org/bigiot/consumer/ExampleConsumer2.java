...
public class ExampleConsumer2 {
	...
	private static final String CONSUMER_ID	    = "Njupt-njuptconsumer2";
	private static final String CONSUMER_SECRET = "VNCGzoD1SCuqaxZcc0i-CA==";
...
//		consumer.addProxyBypass("172.17.17.100"); //Enable this line and the addresses for internal hosts
		...
		Offering offering = consumer.subscribeByOfferingId("Njupt-njuptprovider2-AirHumidityOffering").get();
